...
Make sure to only use 1 to 2 words for each keyword. The first word should be the most relevant word and the second word should be the issue like Failed etc.
